...
ms.openlocfilehash: 548d0418285693bd4639d57f5e1c4486b69a526b
ms.sourcegitcommit: ac1cb9a6531f2c843002914023757ab3f306dc3e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/06/2020
ms.locfileid: "96746634"
---
...
Azure 存储提供了以下四种服务：Blob 存储、表存储、队列存储和文件存储。 若要了解详细信息，请参阅 [Azure 存储简介](../../storage/common/storage-introduction.md)。
...
客户端加密内置于 Java 和 .NET 存储客户端库中。 请参阅[适用于 Azure 存储的客户端加密和 Azure Key Vault](../../storage/common/storage-client-side-encryption.md)，了解如何在客户端应用程序中加密数据，以及如何生成和管理自己的加密密钥。
