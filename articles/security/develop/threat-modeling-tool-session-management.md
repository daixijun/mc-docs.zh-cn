...
ms.openlocfilehash: 879a7e71e560bb59f44840eb626ff077cd68ab32
ms.sourcegitcommit: d8dad9c7487e90c2c88ad116fff32d1be2f2a65d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/11/2020
ms.locfileid: "97105314"
---
...
| **参考**              | [httpCookies 元素（ASP.NET 设置架构）](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/ms228262(v=vs.100))、[HttpCookie.Secure 属性](https://docs.microsoft.com/dotnet/api/system.web.httpcookie.secure) |
...
| **适用的技术** | Web 窗体 |
| **属性**              | 空值  |
| **参考**              | [FormsAuthentication.RequireSSL 属性](https://docs.microsoft.com/dotnet/api/system.web.security.formsauthentication.requiressl) |
...
| **适用的技术** | MVC5 |
| **属性**              | EnvironmentType - OnPrem |
| **参考**              | [Windows Identity Foundation (WIF) 配置 - 第 II 部分](https://docs.microsoft.com/archive/blogs/alikl/windows-identity-foundation-wif-configuration-part-ii-cookiehandler-chunkedcookiehandler-customcookiehandler) |
...
| **适用的技术** | Web 窗体 |
| **属性**              | 空值  |
| **参考**              | [利用 ASP.NET 内置功能来防范 Web 攻击](https://docs.microsoft.com/previous-versions/dotnet/articles/ms972969(v=msdn.10)#securitybarriers_topic2) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [HttpSessionState.Timeout 属性](https://docs.microsoft.com/dotnet/api/system.web.sessionstate.httpsessionstate.timeout) |
