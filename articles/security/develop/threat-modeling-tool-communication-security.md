...
ms.openlocfilehash: b5e2becb3cc7a63c048d8a650a4c112f990f994c
ms.sourcegitcommit: d8dad9c7487e90c2c88ad116fff32d1be2f2a65d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/11/2020
ms.locfileid: "97105362"
---
...
| **适用的技术** | 泛型 |
| **属性**              | 链接服务类型 - Azure 和本地 |
| **参考**              |在本地与 Azure 数据工厂之间移动数据、数据管理网关 |
...
| **参考**              | [启用数据库引擎的加密连接](https://docs.microsoft.com/sql/database-engine/configure-windows/enable-encrypted-connections-to-the-database-engine)  |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [Azure 存储传输级加密 - 使用 HTTPS](../../storage/blobs/security-recommendations.md#networking) |
...
| **属性**              | 空值  |
| **参考**              | [MSDN](https://docs.microsoft.com/previous-versions/msp-n-p/ff648500(v=pandp.10))、[巩固王国](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_transport_security_enabled) |
...
| **适用的技术** | .NET Framework 3 |
| **属性**              | 空值  |
| **参考**              | [MSDN](https://docs.microsoft.com/previous-versions/msp-n-p/ff650862(v=pandp.10)) |
...
| **适用的技术** | .NET Framework 3 |
| **属性**              | 空值  |
| **参考**              | [MSDN](https://docs.microsoft.com/previous-versions/msp-n-p/ff648826(v=pandp.10)) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [选择通信协议](../../iot-hub/iot-hub-devguide.md) |
