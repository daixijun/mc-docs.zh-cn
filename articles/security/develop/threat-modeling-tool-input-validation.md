...
description: 了解 Threat Modeling Tool 中的输入验证。 请参阅缓解措施信息并查看代码示例。
services: security
...
ms.openlocfilehash: d7d6e0b2042f82776d4280cfe23c63e911be0174
ms.sourcegitcommit: d8dad9c7487e90c2c88ad116fff32d1be2f2a65d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/11/2020
ms.locfileid: "97105194"
---
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [XSLT 安全](https://docs.microsoft.com/previous-versions/windows/desktop/ms763800(v=vs.85))、[XsltSettings.EnableScript 属性](https://docs.microsoft.com/dotnet/api/system.xml.xsl.xsltsettings.enablescript) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [XML 实体扩展](https://capec.mitre.org/data/definitions/197.html)、[XML 拒绝服务攻击和防护](https://docs.microsoft.com/archive/msdn-magazine/2009/november/xml-denial-of-service-attacks-and-defenses)、[MSXML 安全概述](https://docs.microsoft.com/previous-versions/windows/desktop/ms754611(v=vs.85))、[有关保护 MSXML 代码的最佳做法](https://docs.microsoft.com/previous-versions/windows/desktop/ms759188(v=vs.85))、[NSXMLParserDelegate 协议参考](https://developer.apple.com/library/ios/#documentation/cocoa/reference/NSXMLParserDelegate_Protocol/Reference/Reference.html)、[解析外部引用](https://docs.microsoft.com/dotnet/standard/data/xml/resolving-external-resources) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [不受限制的文件上传](https://owasp.org/www-community/vulnerabilities/Unrestricted_File_Upload)、[文件签名表](https://www.garykessler.net/library/file_sigs.html) |
...
| **属性**              | 空值  |
| **参考**              | [如何在 ASP.NET 中防止跨站点脚本](https://docs.microsoft.com/previous-versions/msp-n-p/ff649310(v=pandp.10))、[跨站点脚本](https://cwe.mitre.org/data/definitions/79.html)、[XSS（跨站点脚本）预防速查表](https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html) |
...
| **适用的技术** | 泛型、MVC5、MVC6 |
| **属性**              | 空值  |
| **参考**              | [添加验证](https://www.asp.net/mvc/overview/getting-started/introduction/adding-validation)、[验证 MVC 应用程序中的模型数据](https://docs.microsoft.com/previous-versions/dd410404(v=vs.90))、[ASP.NET MVC 应用程序指导原则](https://docs.microsoft.com/archive/msdn-magazine/2009/brownfield/extreme-asp-net-guiding-principles-for-your-asp-net-mvc-applications) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [为不安全的输入编码](https://docs.microsoft.com/previous-versions/msp-n-p/ff647397(v=pandp.10)#paght000003_step3)、[HTML 净化器](https://github.com/mganss/HtmlSanitizer) |
...
| **适用的技术** | 泛型、MVC5、MVC6 |
| **属性**              | 空值  |
| **参考**              | [验证 MVC 应用程序中的模型数据](https://docs.microsoft.com/previous-versions/dd410404(v=vs.90))、[ASP.NET MVC 应用程序指导原则](https://docs.microsoft.com/archive/msdn-magazine/2009/brownfield/extreme-asp-net-guiding-principles-for-your-asp-net-mvc-applications) |
...
| **适用的技术** | 泛型、Web 窗体、MVC5、MVC6  |
| **属性**              | 空值  |
| **参考**              | [DefaultRegexMatchTimeout 属性](https://docs.microsoft.com/dotnet/api/system.web.configuration.httpruntimesection.defaultregexmatchtimeout) |
...
| **属性**              | 空值  |
| **参考**              | [MSDN](https://docs.microsoft.com/previous-versions/msp-n-p/ff647820(v=pandp.10)) |
...
| **适用的技术** | 泛型、NET Framework 3 |
| **属性**              | 空值  |
| **参考**              | [MSDN](https://docs.microsoft.com/previous-versions/msp-n-p/ff647875(v=pandp.10)) |
