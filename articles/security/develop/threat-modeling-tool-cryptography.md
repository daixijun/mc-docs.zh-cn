...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [选择加密算法](https://docs.microsoft.com/sql/relational-databases/security/encryption/choose-an-encryption-algorithm) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [使用数字签名标识包源](https://docs.microsoft.com/sql/integration-services/security/identify-the-source-of-packages-with-digital-signatures)、[威胁和漏洞缓解措施（集成服务）](https://docs.microsoft.com/sql/integration-services/security/security-overview-integration-services) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [ADD SIGNATURE (Transact-SQL)](https://docs.microsoft.com/sql/t-sql/statements/add-signature-transact-sql) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [SQL Server 可扩展密钥管理 (EKM)](https://docs.microsoft.com/sql/relational-databases/security/encryption/extensible-key-management-ekm)、[使用 Azure Key Vault (SQL Server) 可扩展密钥管理](https://docs.microsoft.com/sql/relational-databases/security/encryption/extensible-key-management-using-azure-key-vault-sql-server) |
...
| **参考**              | [Always Encrypted（数据库引擎）](https://docs.microsoft.com/sql/relational-databases/security/encryption/always-encrypted-database-engine) |
...
| **参考**              | [Windows IoT Core 上的 TPM](https://docs.microsoft.com/windows/iot-core/secure-your-device/TPM)、[设置 Windows IoT Core 上的 TPM](https://docs.microsoft.com/windows/iot-core/secure-your-device/setuptpm)、[Azure IoT 设备 SDK TPM](https://github.com/Azure/azure-iot-hub-vs-cs/wiki/Device-Provisioning-with-TPM) |
