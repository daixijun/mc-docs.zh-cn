...
ms.openlocfilehash: 21818c7e89ccb5624693ded765840362c9c563ad
ms.sourcegitcommit: d8dad9c7487e90c2c88ad116fff32d1be2f2a65d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/11/2020
ms.locfileid: "97105315"
---
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [如何：使用 DPAPI 加密 ASP.NET 2.0 中的配置部分](https://docs.microsoft.com/previous-versions/msp-n-p/ff647398(v=pandp.10))、[指定受保护的配置提供程序](https://docs.microsoft.com/previous-versions/68ze1hb2(v=vs.140))、[使用 Azure Key Vault 保护应用程序机密](https://docs.microsoft.com/azure/architecture/multitenant-identity/web-api) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [MSDN：自动完成特性](https://msdn.microsoft.com/library/ms533486(VS.85).aspx)、[在 HTML 中使用自动完成](https://docs.microsoft.com/previous-versions/windows/internet-explorer/ie-developer/)、[HTML 净化漏洞](https://docs.microsoft.com/security-updates/SecurityBulletins/2010/ms10-071)、[又是自动完成？](https://blog.mindedsecurity.com/2011/10/autocompleteagain.html) |
...
| **参考**              | [动态数据掩码](https://docs.microsoft.com/sql/relational-databases/security/dynamic-data-masking) |
...
| **适用的技术** | 泛型 |
| **属性**              | SQL 版本 - 所有 |
| **参考**              | [加密 SQL Server 中的敏感数据](https://docs.microsoft.com/previous-versions/sql/sql-server-2008-r2/ff848751(v=sql.105))、[如何：加密 SQL Server 中数据列](https://docs.microsoft.com/sql/relational-databases/security/encryption/encrypt-a-column-of-data)、[使用证书进行加密](https://docs.microsoft.com/sql/t-sql/functions/encryptbycert-transact-sql) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [了解 SQL Server 透明数据加密 (TDE)](https://docs.microsoft.com/previous-versions/sql/sql-server-2008-r2/bb934049(v=sql.105)) |
...
| **参考**              | [SQL 数据库备份加密](https://docs.microsoft.com/sql/relational-databases/backup-restore/backup-encryption) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [Azure 存储的客户端加密和 Azure Key Vault](../../storage/common/storage-client-side-encryption.md)，[教程：在 Azure 存储中使用 Azure Key Vault 加密和解密 Blob](../../storage/blobs/storage-encrypt-decrypt-blobs-key-vault.md)、[使用 Azure 加密扩展在 Azure Blob 存储中安全存储数据](https://docs.microsoft.com/archive/blogs/partnercatalystteam/storing-data-securely-in-azure-blob-storage-with-azure-encryption-extensions) |
...
| **属性**              | 安全模式 - 传输，安全模式 - 消息 |
| **参考**              | [MSDN](https://docs.microsoft.com/previous-versions/msp-n-p/ff648500(v=pandp.10))、[巩固王国](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_weak_class_reference)、[WCF 安全基础知识 - CoDe 杂志](https://www.codemag.com/article/0611051) |
