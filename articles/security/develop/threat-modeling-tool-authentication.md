...
ms.openlocfilehash: 58fd983ac5a3fa878912e054a10e1b365846c0e8
ms.sourcegitcommit: d8dad9c7487e90c2c88ad116fff32d1be2f2a65d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/11/2020
ms.locfileid: "97105364"
---
...
| **适用的技术** | OnPrem |
| **属性**              | SQL 版本 - 所有 |
| **参考**              | [SQL Server - 选择身份验证模式](https://docs.microsoft.com/sql/relational-databases/security/choose-an-authentication-mode) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [SQL Server 密码策略](https://docs.microsoft.com/previous-versions/sql/sql-server-2012/ms161959(v=sql.110)) |
...
| **参考**              | [针对包含的数据库的安全最佳做法](https://docs.microsoft.com/sql/relational-databases/databases/security-best-practices-with-contained-databases) |
...
| **属性**              | 空值 |
| **参考**              | [MSDN](https://docs.microsoft.com/previous-versions/msp-n-p/ff648500(v=pandp.10)) |
...
| **属性**              | 客户端凭据类型 - None |
| **参考**              | [MSDN](https://docs.microsoft.com/previous-versions/msp-n-p/ff648500(v=pandp.10))、[Fortify](https://community.microfocus.com/t5/UFT-Discussions/UFT-API-Test-with-WCF-wsHttpBinding/m-p/600927) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [Azure AD 的身份验证方案](../../active-directory/develop/authentication-vs-authorization.md)、[Azure Active Directory 代码示例](../../active-directory/azuread-dev/sample-v1-code.md)、[Azure Active Directory 开发人员指南](../../active-directory/develop/index.yml) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [使用 Azure Active Directory 对 Web 应用程序执行新式身份验证](https://docs.microsoft.com/archive/blogs/microsoft_press/new-book-modern-authentication-with-azure-active-directory-for-web-applications)、[使用 Redis 作为 ADAL 令牌缓存](https://blogs.msdn.microsoft.com/mrochon/2016/09/19/using-redis-as-adal-token-cache/)  |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [使用 Azure Active Directory 对 Web 应用程序执行新式身份验证](https://docs.microsoft.com/archive/blogs/microsoft_press/new-book-modern-authentication-with-azure-active-directory-for-web-applications) |
