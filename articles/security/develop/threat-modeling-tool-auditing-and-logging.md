...
ms.openlocfilehash: 01dea775fa7bee1963af0e24bce141bf2fd67622
ms.sourcegitcommit: d8dad9c7487e90c2c88ad116fff32d1be2f2a65d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/11/2020
ms.locfileid: "97104297"
---
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [配置登录审核](https://docs.microsoft.com/sql/ssms/configure-login-auditing-sql-server-management-studio) |
...
| **适用的技术** | .NET framework |
| **属性**              | 空值  |
| **参考**              | [MSDN](https://docs.microsoft.com/previous-versions/msp-n-p/ff648500(v=pandp.10))、[巩固王国](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_insufficient_logging) |
...
| **适用的技术** | .NET framework |
| **属性**              | 空值  |
| **参考**              | [MSDN](https://docs.microsoft.com/previous-versions/msp-n-p/ff648500(v=pandp.10))、[巩固王国](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_insufficient_audit_failure_handling) |
