...
description: 查看有关估计容量和管理搜索服务成本的指导，包括 Azure 中的基础结构和工具，以及更有效地使用资源的最佳做法。
manager: nitinme
author: HeidiSteen
ms.author: v-tawe
...
ms.date: 01/14/2021
ms.openlocfilehash: c748d747562be6408ea50bcd18870e598a9f6958
ms.sourcegitcommit: 01cd9148f4a59f2be4352612b0705f9a1917a774
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/14/2021
ms.locfileid: "98194852"
---
# <a name="how-to-estimate-capacity-and-costs-of-an-azure-cognitive-search-service"></a>如何估计 Azure 认知搜索服务的容量和成本

作为 Azure 认知搜索容量计划的一部分，以下指南可帮助你降低成本或更有效地管理成本：
...
容量与运行服务的成本密切相关。 层对两个级别施加限制：存储和内容（例如索引数）。 应该同时考虑到此两者，因为首先达到的限制就是实施的限制。
...
“免费”层和预览版功能不提供服务级别协议 (SLA)。 对于所有可计费的层，SLA 将在用户为服务提供足够冗余时生效。 需要为查询（读取）SLA 提供两个或更多个副本。 需要为查询和索引（读写）SLA 提供三个或更多个副本。 分区数不影响 SLA。
...
> [!NOTE]
> 如有问题，请在 [StackOverflow](https://stackoverflow.com/questions/tagged/azure-search) 中发贴或[联系 Azure 支持部门](https://support.azure.cn/)。