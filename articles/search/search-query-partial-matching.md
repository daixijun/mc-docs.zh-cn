...
ms.date: 01/14/2021
ms.openlocfilehash: 98547cfebee47e8518d28c3091a8b4d6d4264b5f
ms.sourcegitcommit: 01cd9148f4a59f2be4352612b0705f9a1917a774
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/14/2021
ms.locfileid: "98194781"
---
...
## <a name="about-partial-term-search"></a>关于部分术语搜索
...
1. 定义一个字段，用于存储字符串的原有版本（假设在查询时需要已分析的和未分析的文本）
1. 对各种可在适当粒度级别发出标记的分析器进行评估和选择
1. 将分析器分配到字段
1. 生成并测试索引
...
+ [设置分析器](#set-an-analyzer)中介绍了[测试分析器](https://docs.microsoft.com/rest/api/searchservice/test-analyzer)。 请使用各种分析器来测试索引中的一些字符串，以了解字词的标记化方式。
