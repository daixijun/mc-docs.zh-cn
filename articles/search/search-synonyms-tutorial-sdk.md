...
> [!div class="checklist"]
> * 使用 [SynonymMap 类](https://docs.microsoft.com/dotnetapi/azure.search.documents.indexes.models.synonymmap)创建同义词映射。 
> * 在应该支持通过同义词进行查询扩展的字段上设置 [SynonymMapsName 属性](https://docs.microsoft.com/dotnetapi/azure.search.documents.indexes.models.searchfield.synonymmapnames)。
...
本示例使用 C# 代码演示了同义词功能，创建并发布了映射规则，然后在查询中调用同义词映射。 可以在 [.NET SDK](https://docs.microsoft.com/dotnetapi/overview/azure/search.documents-readme) 和 [REST API](https://docs.microsoft.com/rest/api/searchservice/) 参考文档中找到更多信息。
