...
ms.author: v-yeche
ms.custom: ''
ms.openlocfilehash: 6a93298ae84dba75f6af4225803b04314ebebba4
ms.sourcegitcommit: b072689d006cbf9795612acf68e2c4fee0eccfbc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/18/2020
ms.locfileid: "94849516"
---
<!--Not Avaialble on Azure China cloud-->
<!--docker login azure only login Azure Public Cloud -->
...
使用 Docker 开发云原生应用时，如果希望从本地开发无缝切换到云部署，可以按需在 Azure 容器实例中运行容器。 此功能是通过 [Docker 与 Azure 之间的集成](https://docs.docker.com/engine/context/aci-integration/)启用的。 你可以使用原生 Docker 命令在 Azure 中运行单容器实例或多容器组。

<!--Not Avaialble on [a single container instance](quickstart-docker-cli.md)-->
...
* **Azure CLI** - 必须已在本地计算机上安装了 Azure CLI。 建议使用 2.10.1 或更高版本。 运行 `az --version` 即可查找版本。 如需进行安装或升级，请参阅[安装 Azure CLI](https://docs.azure.cn/cli/install-azure-cli)。
...
若要验证映像是否存储在注册表中，请运行 [az acr repository show](https://docs.azure.cn/cli/acr/repository#az_acr_repository_show) 命令：
...
<!-- Update_Description: new article about tutorial docker compose -->
<!--NEW.date: 11/23/2020-->