...
- 一个 [Azure 存储帐户](../storage/common/storage-account-overview.md?toc=%252fstorage%252fblobs%252ftoc.json#types-of-storage-accounts)。常规用途 v2 帐户是首选，但任何支持 Azure Blob 存储的 Azure 存储帐户也可以使用。
