...
ms.openlocfilehash: b6748fb98ff9c3d24b029bd5aae943b314c54f54
ms.sourcegitcommit: 39288459139a40195d1b4161dfb0bb96f5b71e8e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/13/2020
ms.locfileid: "94590962"
---
# <a name="azure-security-baseline-for-azure-dns"></a>适用于 Azure DNS 的 Azure 安全基线

适用于 Azure DNS 的 Azure 安全基线包含有助于改进部署安全状况的建议。 此服务的基线摘自 [Azure 安全基准版本 1.0](../security/benchmarks/overview.md)，其中提供了有关如何根据我们的最佳做法指导保护 Azure 上的云解决方案的建议。 有关详细信息，请参阅 [Azure 安全基线概述](../security/benchmarks/security-baselines-overview.md)。
...
通过 Azure Monitor 引入日志，以聚合终结点设备、网络资源和其他安全系统生成的安全数据。 也可以启用数据并将其加入第三方 SIEM。
...
你需要负责预先扫描要上传到非计算 Azure 资源的任何内容。 Azure 无法访问客户数据，因此无法代表你对客户内容执行反恶意软件扫描。
