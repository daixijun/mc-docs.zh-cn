...
Manage Azure DDoS Protection Standard using the Azure portal: https://docs.azure.cn/virtual-network/manage-ddos-protection

Threat detection for the Azure service layer in Azure Security Center: https://docs.azure.cn/security-center/security-center-alerts-service-layer
...
<!-- Azure Active Directory risk detections: https://docs.azure.cn/active-directory/reports-monitoring/concept-risk-events -->
...
**Guidance**: Use Azure Active Directory's Identity Protection and risk detection features to configure automated responses to detected suspicious actions related to your Azure Key Vault protected resources.

Risky sign-ins report in the Azure Active Directory portal: https://docs.azure.cn/active-directory/reports-monitoring/concept-risky-sign-ins 

How To: Configure and enable risk policies: https://docs.azure.cn/active-directory/identity-protection/howto-identity-protection-configure-risk-policies
