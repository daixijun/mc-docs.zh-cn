...
<!-- With the Azure CLI, use the [az monitor diagnostic-settings update](/cli/monitor/diagnostic-settings?view=azure-cli-latest#az_monitor_diagnostic_settings_update) command. 
