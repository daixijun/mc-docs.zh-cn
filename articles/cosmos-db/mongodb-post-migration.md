...
- [为 Azure Cosmos DB MongoDB API 配置多区域分发](#multiple-regionally-distribute-your-data)
...
## <a name="connect-your-application"></a><a name="connect-your-application"></a>连接应用程序 
...
<a name="indexing"></a>
## <a name="optimize-the-indexing-policy"></a><a name="optimize-the-indexing-policy"></a>优化索引策略
