...
本文详细介绍了如何在 [Azure Databricks](https://docs.azure.cn/databricks/scenarios/what-is-azure-databricks) 上通过 Spark 使用 Azure Cosmos DB Cassandra API。
...
* [预配 Azure Databricks 群集](https://docs.azure.cn/databricks/scenarios/quickstart-create-databricks-workspace-portal)
...
<!-- Update_Description: new article about cassandra spark databricks -->
<!--NEW.date: 12/14/2020-->