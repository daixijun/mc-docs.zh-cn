...
ms.date: 12/07/2020
ms.openlocfilehash: 80da968f905a7c657e093440cfdf9e3118d57523
ms.sourcegitcommit: ac1cb9a6531f2c843002914023757ab3f306dc3e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/06/2020
ms.locfileid: "96746835"
---
...
1. 在“映射到目标数据库”  屏幕上，映射源和目标数据库以进行迁移。
    ...
    在迁移的这个时候，可以[预配吞吐量](../cosmos-db/set-throughput.md)。 在 Cosmos DB 中，可在数据库级别预配吞吐量，也可为每个集合单独进行预配。 吞吐量以[请求单位](../cosmos-db/request-units.md) (RU) 来度量。 深入了解 [Azure Cosmos DB 定价](https://azure.cn/pricing/details/cosmos-db/)。
...
3. 在“集合设置”屏幕上，展开集合列表，然后查看要迁移的集合的列表。 
    ...
    也可指定分片键来利用 [Azure Cosmos DB 中的分区](../cosmos-db/partitioning-overview.md)，以便优化可伸缩性。 确保查看[选择分片/分区键的最佳做法](../cosmos-db/partitioning-overview.md#choose-partitionkey)。
