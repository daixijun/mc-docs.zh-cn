...
ms.date: 09/11/2019
ms.topic: reference
ms.openlocfilehash: ac26eec1c9dcd5041920e8d1cee4db9bbcc493a2
ms.sourcegitcommit: c2c9dc65b886542d220ae17afcb1d1ab0a941932
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/20/2020
ms.locfileid: "94978271"
---
...
- **bcp**：bcp 工具在 Microsoft SQL Server 实例与用户指定格式的数据文件之间批量复制数据。 可以使用 bcp 工具将大量新行导入 SQL Server 表，或者将表中的数据导出到数据文件。 要将数据导入表中，必须使用为该表创建的格式文件。 或者，必须了解表的结构，以及对其列有效的数据类型。
  ...
  有关详细信息，请参阅[使用 bcp 连接](https://docs.microsoft.com/sql/connect/odbc/linux-mac/connecting-with-bcp)。

- **sqlcmd**：可以使用 sqlcmd 工具输入 Transact-SQL 语句。 还可以在命令提示符下输入系统过程和脚本文件。 此工具使用 ODBC 运行 Transact-SQL 批处理。

  有关详细信息，请参阅[使用 sqlcmd 连接](https://docs.microsoft.com/sql/connect/odbc/linux-mac/connecting-with-sqlcmd)。
