...
ms.openlocfilehash: 6bd74aa81318f294e576676a255254c3eac452f6
ms.sourcegitcommit: 79a5fbf0995801e4d1dea7f293da2f413787a7b9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/08/2021
ms.locfileid: "98022433"
---
...
创建一个[试验](https://docs.microsoft.com/python/api/azureml-core/azureml.core.experiment.experiment?preserve-view=true&view=azure-ml-py)，用于跟踪强化学习运行。 在 Azure 机器学习中，试验是相关试运行的逻辑集合，用于组织运行日志、历史记录、输出等信息。
...
头节点计算使用单个 `STANDARD_NC6` 虚拟机 (VM)。 它有 6 个可以分配工作的虚拟 CPU。
...
使用 [ReinforcementLearningEstimator](https://docs.microsoft.com/python/api/azureml-contrib-reinforcementlearning/azureml.contrib.train.rl.reinforcementlearningestimator?preserve-view=true&view=azure-ml-py) 将训练的作业提交到 Azure 机器学习。
...
头节点是有 6 个 vCPU 的 Standard_NC6。 工作器节点群集是 4 个 [Standard_D2_V2 VM](../cloud-services/cloud-services-sizes-specs.md#dv2-series)，每个 VM 有 2 个 CPU，因此总共有 8 个 CPU。 但是，必须从工作器计数中减去 1 个 CPU，因为必须有 1 个 CPU 专用于头节点角色。
...
[运行](https://docs.microsoft.com/python/api/azureml-core/azureml.core.run%28class%29?preserve-view=true&view=azure-ml-py)处理正在进行的或已完成的作业的运行历史记录。 
