...
ms.author: keli19
ms.date: 04/13/2020
ms.openlocfilehash: d4032b8cd7ca0c753766cb85ba2b2db11062de68
ms.sourcegitcommit: c2c9dc65b886542d220ae17afcb1d1ab0a941932
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/20/2020
ms.locfileid: "94977768"
---
...
从训练管道[创建实时推理管道](/machine-learning/tutorial-designer-automobile-price-deploy#create-a-real-time-inference-pipeline)时，将自动添加 Web 服务输入和 Web 服务输出模块，以显示用户数据进入管道的位置和数据返回的位置。 
...
详细了解[部署实时终结点](/machine-learning/tutorial-designer-automobile-price-deploy#deploy-the-real-time-endpoint)。
