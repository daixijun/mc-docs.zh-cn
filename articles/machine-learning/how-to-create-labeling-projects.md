...
ms.topic: tutorial
ms.date: 07/27/2020
ms.openlocfilehash: 68d0febdac6ae568f6743600a19795edb49595db
ms.sourcegitcommit: c2c9dc65b886542d220ae17afcb1d1ab0a941932
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/20/2020
ms.locfileid: "94978183"
---
...
[Azure 机器学习](https://studio.ml.azure.cn/)数据标签提供一个中心位置用于创建、管理和监视标记项目。 使用机器学习可以协调数据、标签和团队成员，以有效地管理标记任务。 机器学习支持多标签或多类图像分类，以及带边界框的对象标识。
