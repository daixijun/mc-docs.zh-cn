...
> [!TIP]
> 对于 Windows，虽然不是必需的，但强烈建议[将 Docker 与适用于 Linux 的 Windows 子系统 (WSL) 2 配合使用](https://docs.microsoft.com/windows/wsl/tutorials/wsl-containers#install-docker-desktop)。
