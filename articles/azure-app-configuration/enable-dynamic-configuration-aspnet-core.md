...
ms.openlocfilehash: 8b4280743f46c305a3bc8a6525f0080ec8783889
ms.sourcegitcommit: 5df3a4ca29d3cb43b37f89cf03c1aa74d2cd4ef9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/01/2020
ms.locfileid: "96437400"
---
...
sentinel 键是用于在配置更改时发出信号的特殊键。 应用会监视 sentinel 键以了解更改情况。 检测到更改时，刷新所有配置值。 与监视所有键以了解更改情况相比，这种方法可减少应用对 Azure 应用程序配置发出的请求的总数。
