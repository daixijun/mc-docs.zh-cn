...
ms.author: v-junlch
ms.subservice: B2C
ms.openlocfilehash: b20ca11146e8c3d2023f54d3c47bb6acb46e62be
ms.sourcegitcommit: 292892336fc77da4d98d0a78d4627855576922c5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/19/2021
ms.locfileid: "98570884"
---
...
> [!IMPORTANT]
> Facebook 在中国不可用。 请使用 [qq](identity-provider-qq.md)、[wechat](identity-provider-wechat.md) 或 [weibo](identity-provider-weibo.md) 作为 Azure 中国的标识提供者。
> 
...
1. 在“重定向 URI”下，选择“Web”，然后输入 `https://your-tenant-name.b2clogin.cn/your-tenant-name.partner.onmschina.cn`，其中 `your-tenant-name` 是 Azure AD B2C 租户域名 。
