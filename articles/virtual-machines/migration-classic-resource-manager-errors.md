...
description: 本文编录了将 IaaS 资源从 Azure 服务管理迁移到 Azure 资源管理器期间的最常见错误和缓解措施。
manager: vashan
...
ms.testdate: ''
ms.author: v-yeche
ms.openlocfilehash: fd91b86a862bfe1f5632b1ce0b662bb343e5cd06
ms.sourcegitcommit: 8f438bc90075645d175d6a7f43765b20287b503b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/10/2020
ms.locfileid: "97004336"
---
<!--Verified successfully from renamed Linux article-->
...
| 托管服务 {hosted-service-name} 中的部署 {deployment-name} 不支持迁移，因为它具有多个可用性集。 |目前，仅具有 1 个或更少可用性集的托管服务可以迁移。 若要解决此问题，请将其他可用性集以及其中的虚拟机移到其他托管服务。 |
...
<!-- Update_Description: new article about migration classic resource manager errors -->
<!--NEW.date: 12/14/2020-->