...
ms.testdate: ''
ms.author: v-yeche
ms.openlocfilehash: 7d8607a92b2702ad6471d8abf15e6fa7454ffc74
ms.sourcegitcommit: 39288459139a40195d1b4161dfb0bb96f5b71e8e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/13/2020
ms.locfileid: "94590762"
---
...
[Azure 计算单元 (ACU)](./acu.md?bc=%252fazure%252fvirtual-machines%252flinux%252fbreadcrumb%252ftoc.json&toc=%252fazure%252fvirtual-machines%252flinux%252ftoc.json)：多种多样*<br />
...
**答**：当 VM 状态为“已重新部署”并且 VM 移到另一节点时，累积的信用额度将丢失。 如果 VM 已停止/已启动，但仍保留在同一节点，VM 将保留累积的信用额度。 只要 VM 在节点上重新启动，它就会获取初始额度，对于 Standard_B8ms，该额度为 240。
