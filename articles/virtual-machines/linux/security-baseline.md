...
或者，可以启用数据并将其载入第三方 SIEM，以监视和查看日志。
...
**指导**：使用 Azure Active Directory 的风险和标识保护功能配置对检测到的与存储帐户资源相关的可疑操作的自动响应。
...
* [适用于 Linux 虚拟机的诊断扩展](../extensions/diagnostics-linux.md?toc=/azure-monitor/toc.json)
