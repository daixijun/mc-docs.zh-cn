...
|                             | 持久 OS 磁盘                          | 临时 OS 磁盘                              |
|-----------------------------|---------------------------------------------|------------------------------------------------|
| **OS 磁盘的大小限制** | 2 TiB                                                                                        | 与 VM 大小相对应的缓存大小或 2TiB，具体取决于哪一个更小。 对于“缓存大小(GiB)”，请参阅  [DS](sizes-general.md)、[ES](sizes-memory.md)、[M](sizes-memory.md) 和 [FS](sizes-compute.md)          |
| **支持的 VM 大小** | 全部                                                                                          | 支持高级存储的 VM 大小，例如 DSv1、DSv2、DSv3、Esv3、Fs、FsV2、M                                               |
...
:::image type="content" source="./media/virtual-machines-common-ephemeral/ephemeral-portal.png" alt-text="显示单选按钮的屏幕截图，该按钮选中后即可使用临时 OS 磁盘":::
