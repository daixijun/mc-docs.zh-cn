...
ms.date: 11/30/2020
ms.author: v-jay
ms.openlocfilehash: ee2121dfa2b50a2a8931adc992f836f3c3a5d8fe
ms.sourcegitcommit: b6fead1466f486289333952e6fa0c6f9c82a804a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/27/2020
ms.locfileid: "96300827"
---
...
* 适用于 [.NET](/dotnet/api/overview/mediaservices/management)、.NET Core、[Node.js](https://docs.microsoft.com/javascript/api/overview/azure/mediaservices/management)、[Python](https://docs.microsoft.com/python/api/overview/azure/mediaservices/management)、[Java](https://docs.microsoft.com/java/api/overview/azure/mediaservices/management)、[Go](https://aka.ms/ams-v3-go-ref) 和 Ruby 的 SDK。
* 简化脚本支持的 [Azure CLI](https://docs.microsoft.com/cli/azure/ams) 集成。
...
* 可对实体使用 Azure 基于角色的访问控制 (Azure RBAC)。 
...
*  目前，可以使用 [Azure 门户](https://portal.azure.cn/)执行以下操作：
    ...
    * [获取有关访问 API 的信息](./access-api-howto.md)。 
    ...
    对于其他所有管理任务（例如，[转换和作业](transforms-jobs-concept.md)和[内容保护](content-protection-overview.md)），请使用 [REST API](https://docs.microsoft.com/rest/api/media/)、[CLI](https://docs.microsoft.com/cli/azure/ams) 或某个受支持的 [SDK](media-services-apis-overview.md#sdks)。
