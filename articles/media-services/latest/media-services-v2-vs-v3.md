...
* 若要了解与资产相关的更改，请参阅下面的[特定于资产的更改](#asset-specific-changes)部分。
...
* 以下实体已重命名：
   ...
   * v3 JobOutput 取代了 v2 Task，现在属于作业的一部分。 输入和输出现在处于作业级别。 有关详细信息，请参阅[从本地文件创建作业输入](job-input-from-local-file-how-to.md)。 
