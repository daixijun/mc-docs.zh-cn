...
1. 在“创建命名空间”页上执行以下步骤  ：  
   ...
   1. 选择命名空间所在的 **位置**。
   1. 选择 **定价层**（基本或标准）。 若要了解基本层和标准层之间的一些差异，请参阅[事件中心定价](https://www.azure.cn/pricing/details/event-hubs/)、[层之间的差异](event-hubs-faq.md#what-is-the-difference-between-event-hubs-basic-and-standard-tiers)以及[配额和限制](event-hubs-quotas.md)。 
