...
如何为 Azure 事件中心命名空间配置 IP 防火墙规则： https://docs.azure.cn/event-hubs/event-hubs-ip-filtering
...
适用于事件中心命名空间的 Azure 内置策略： https://docs.azure.cn/governance/policy/samples/built-in-policies#event-hub



适用于网络的 Azure Policy 示例： https://docs.azure.cn/governance/policy/samples/built-in-policies#network
...
如何配置 Azure 事件中心的诊断设置： https://docs.azure.cn/event-hubs/event-hubs-diagnostic-logs

了解 Azure 活动日志： https://docs.azure.cn/azure-monitor/platform/platform-logs-overview
...
如何启用 Azure 事件中心的诊断设置： https://docs.azure.cn/event-hubs/event-hubs-diagnostic-logs
...
**指导**：分析和监视日志中的异常行为，并定期查看与事件中心相关的结果。 使用 Azure Monitor 的 Log Analytics 检查日志并对日志数据执行查询。
...
<!-- How to onboard Azure Sentinel: https://docs.azure.cn/sentinel/quickstart-onboard -->
...
如何针对 Log Analytics 工作区日志数据发出警报： https://docs.azure.cn/azure-monitor/learn/tutorial-response
...
了解事件中心的共享访问签名： https://docs.azure.cn/event-hubs/authenticate-shared-access-signature
...
如何使用 Azure 安全中心监视标识和访问（预览版）： https://docs.azure.cn/security-center/security-center-identity-access

如何使用 Azure Policy： https://docs.azure.cn/governance/policy/tutorials/create-and-manage
...
**指导**：Microsoft Azure 基于 Azure Active Directory (AD) 针对资源和应用程序提供了集成的访问控制管理功能。 将 Azure AD 与 Azure 事件中心配合使用的主要优势在于，不再需要将凭据存储在代码中。 可以从 Microsoft 标识平台请求 OAuth 2.0 访问令牌。 用于请求令牌的资源名称为 https:\//eventhubs.azure.cn/。 Azure AD 对运行应用程序的安全主体（用户、组或服务主体）进行身份验证。 如果身份验证成功，Azure AD 会将访问令牌返回应用程序，应用程序可随之使用访问令牌对 Azure 事件中心资源请求授权。

如何使用 Azure AD 对访问事件中心资源的应用程序进行身份验证： https://docs.azure.cn/event-hubs/authenticate-application
...
了解 Azure AD 风险检测： https://docs.azure.cn/active-directory/reports-monitoring/concept-risk-events

如何为自定义警报和通知配置操作组： https://docs.azure.cn/azure-monitor/platform/action-groups
...
若要了解 Azure 事件中心如何与 Azure Active Directory (AAD) 集成，请参阅“使用 Azure Active Directory 授予对事件中心资源的访问权限”： https://docs.azure.cn/event-hubs/authorize-access-azure-active-directory
...
使用 Azure Active Directory 授予对事件中心资源的访问权限： https://docs.azure.cn/event-hubs/authorize-access-azure-active-directory
...
**Guidance**: Use Azure Active Directory's Identity Protection and risk detection features to configure automated responses to detected suspicious actions related to your Event Hubs-enabled resources.
...
List of Customer Lockbox-supported services: https://docs.azure.cn/security/fundamentals/customer-lockbox-overview#supported-services-and-scenarios-in-general-availability
...
为 Azure 事件中心命名空间配置 IP 防火墙规则： https://docs.azure.cn/event-hubs/event-hubs-ip-filtering
...
<!-- Understand Virtual Network Service Endpoints with Azure Event Hubs: https://docs.azure.cn/event-hubs/event-hubs-service-endpoints -->

<!-- Integrate Azure Event Hubs with Azure Private Link: https://docs.azure.cn/event-hubs/private-link-service -->

了解网络安全组和服务标记： https://docs.azure.cn/virtual-network/security-overview
...
To understand security features of Event Hubs, see Network security:  https://docs.azure.cn/event-hubs/network-security
...
了解 Azure 事件中心的 Azure AD RBAC 和可用角色： https://docs.azure.cn/event-hubs/authorize-access-azure-active-directory
...
How to configure customer-managed keys for encrypting Azure Event Hubs: https://docs.azure.cn/event-hubs/configure-customer-managed-key
...
有关 Azure Policy 效果的详细信息： https://docs.azure.cn/governance/policy/concepts/effects
...
使用 Azure Active Directory 对托管标识进行身份验证，以便访问事件中心资源： https://docs.azure.cn/event-hubs/authenticate-managed-identity?tabs=latest

<!-- Configure customer-managed keys for Event Hubs: https://docs.azure.cn/event-hubs/configure-customer-managed-key  -->

<!-- How to integrate with Azure Managed Identities: https://docs.azure.cn/azure-app-configuration/howto-integrate-azure-managed-service-identity -->
...
Understand geo-disaster recovery for Azure Event Hubs: https://docs.azure.cn/event-hubs/event-hubs-geo-dr#availability-zones
...
How to configure customer-managed keys for encrypting Azure Event Hubs data at rest: https://docs.azure.cn/event-hubs/configure-customer-managed-key
...
How to enable soft-delete in Key Vault: https://docs.azure.cn/storage/blobs/storage-blob-soft-delete?tabs=azure-portal

Set up a key vault with keys: https://docs.azure.cn/event-hubs/configure-customer-managed-key

Soft delete for Azure Storage blobs: https://docs.azure.cn/storage/blobs/storage-blob-soft-delete?tabs=azure-portal
...
**Guidance**: Export your Azure Security Center alerts and recommendations using the Continuous Export feature. Continuous Export allows you to export alerts and recommendations either manually or in an ongoing, continuous fashion. 
