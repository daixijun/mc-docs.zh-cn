...
<!--Not Available on [low-priority nodes](batch-low-pri-vms.md)-->
...
<!--Not Available on a target value for low-priority nodes, or both.-->
...
<!--Not Available on #### Preempted nodes-->
...
<!--Not Available on Similarly, the `$TargetLowPriorityNodes` variable can be specified using the alias `$TargetLowPriority`-->
...
<!--Not Available on | $CurrentLowPriorityNodes |-->
<!--Not Available on | $PreemptedNodeCount |-->
