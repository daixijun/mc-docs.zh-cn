...
ms.openlocfilehash: 763a6347ac7d5380f36528ba61dbc115102668da
ms.sourcegitcommit: 79a5fbf0995801e4d1dea7f293da2f413787a7b9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/08/2021
ms.locfileid: "98022010"
---
...
5. 在主要任务和所有子任务成功完成协调命令 *以后*，主要任务会在主节点上执行 **应用程序命令**。 应用程序命令是多实例任务本身的命令行，只由主要任务执行。 在基于 [MS-MPI][msmpi_msdn] 的解决方案中，用户会在此处使用 `mpiexec.exe` 执行已启用 MPI 的应用程序。
...
多实例任务需要有 **已启用节点间通信** 和 **已禁用并发任务执行** 的池。 若要禁止执行并发任务，请将 [CloudPool.TaskSlotsPerNode](https://docs.azure.cn/dotnet/api/microsoft.azure.batch.cloudpool) 属性设置为 1。
...
<!--Not Available on [RDMA-capable size](../virtual-machines/sizes-hpc.md?toc=/virtual-machines/windows/toc.json)-->
...
* **VirtualMachineConfiguration** 池
    ...
    * [Azure 中虚拟机的大小](../virtual-machines/sizes.md?toc=%2fvirtual-machines%2flinux%2ftoc.json) (Linux)
    * [Azure 中虚拟机的大小](../virtual-machines/sizes.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json) (Windows)
...
> [!TIP]
> 此批处理 Linux MPI 代码示例包含一个示例，介绍了如何使用这些环境变量中的其中几个。
...
* Azure HPC 和 Azure Batch 团队博客讨论 [Azure Batch 上针对 Linux 的 MPI 支持][blog_mpi_linux]，并介绍如何将 [OpenFOAM][openfoam] 与 Batch 配合使用。 可以查找适用于 [GitHub 上的 OpenFOAM 示例][github_mpi]的 Python 代码示例。
...
[msmpi_msdn]: https://docs.microsoft.com/message-passing-interface/microsoft-mpi
...
[net_jobprep]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.jobpreparationtask
[net_multiinstance_class]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.multiinstancesettings
[net_multiinstance_prop]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.cloudtask
[net_multiinsance_commonresfiles]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.multiinstancesettings
[net_multiinstance_coordcmdline]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.multiinstancesettings
[net_multiinstance_numinstances]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.multiinstancesettings
[net_pool]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.cloudpool
[net_pool_create]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.pooloperations
[net_pool_starttask]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.cloudpool
[net_resourcefile]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.resourcefile
[net_starttask]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.starttask
[net_starttask_cmdline]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.starttask
[net_task]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.cloudtask
[net_taskconstraints]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.taskconstraints
[net_taskconstraint_maxretry]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.taskconstraints
[net_taskconstraint_maxwallclock]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.taskconstraints
[net_taskconstraint_retention]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.taskconstraints
[net_task_listsubtasks]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.cloudtask
[net_task_listnodefiles]: https://docs.azure.cn/dotnet/api/microsoft.azure.batch.cloudtask
