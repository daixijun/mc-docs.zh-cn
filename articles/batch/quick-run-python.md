...
- mvc
- devx-track-python
ms.openlocfilehash: 4a0dd770c19347a6fa4f5f4c130910dc023f720d
ms.sourcegitcommit: ac1cb9a6531f2c843002914023757ab3f306dc3e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/06/2020
ms.locfileid: "96747033"
---
...
:::image type="content" source="./media/quick-run-python/overview-of-the-azure-batch-workflow.png" alt-text="Azure Batch 工作流概述":::
...
> [!NOTE]
> 在运行 `python python_quickstart_client.py` 脚本之前，请在 `azureblob.BlockBlobService` 中追加参数 `endpoint_suffix=config._STORAG_ENDPOINT_SUFFIX`。
> 
> 相应脚本类似于以下代码：
> ```python
...
应用使用 `blob_client` 引用在存储帐户中创建容器，然后将数据文件上传到该容器。 存储中的文件定义为 Batch [ResourceFile](https://docs.microsoft.com/python/api/azure-batch/azure.batch.models.resourcefile) 对象，Batch 随后可以将这些对象下载到计算节点。
