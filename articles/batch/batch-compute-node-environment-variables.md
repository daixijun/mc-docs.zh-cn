...
ms.author: v-yeche
ms.openlocfilehash: 0424913cede2585001879a583addbcaee2330fae
ms.sourcegitcommit: c8ec440978b4acdf1dd5b7fda30866872069e005
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/15/2021
ms.locfileid: "98231022"
---
# <a name="azure-batch-runtime-environment-variables"></a>Azure Batch 运行时环境变量

[Azure Batch 服务](https://www.azure.cn/home/features/batch/)在计算节点上设置以下环境变量。 可以在任务命令行中引用这些环境变量，也可在命令行运行的程序和脚本中引用它们。
...
这些环境变量只在任务用户（节点上执行任务的用户帐户）的上下文中可见。 在通过远程桌面协议 (RDP) 或安全外壳 (SSH) [远程连接](./error-handling.md#connect-to-compute-nodes)到计算节点并列出环境变量时，你不会看到这些变量。 这是因为，用于远程连接的用户帐户与任务使用的帐户不同。
