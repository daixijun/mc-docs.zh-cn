...
<!--CORRECT ON Microsoft Threat Intelligence feed-->
...
<!--Not Avaiablle on https://docs.azure.cn/active-directory-domain-services/tutorial-create-instance-->
...
<!--Not Available on https://docs.azure.cn/devops/repos/git/gitworkflow?view=azure-devops-->
...
<!--CORRECT ON Microsoft Antimalware-->
...
<!--Not Avaialble on ### 10.5: Incorporate security alerts into your incident response system-->
<!--Not Avaialble on https://docs.azure.cn/security-center/continuous-export-->
<!--Not Avaialble on https://docs.azure.cn/sentinel/connect-azure-security-center-->

### <a name="106-automate-the-response-to-security-alerts"></a>10.6：自动响应安全警报

**指导**：使用 Azure 安全中心内的工作流自动化功能可以通过“逻辑应用”针对安全警报和建议自动触发响应。

<!--Not Avaialble on https://docs.azure.cn/security-center/workflow-automation-->
