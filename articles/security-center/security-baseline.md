...
<!--Not available in MC: ### 3.4: Use single sign-on (SSO) with Azure Active Directory-->
...
<!--Not available in MC: ### 3.12: Alert on account login behavior deviation -->
...
<!--Not available in MC: ### 7.5: Securely store configuration of Azure resources-->
