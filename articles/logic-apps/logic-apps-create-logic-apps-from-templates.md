...
ms.openlocfilehash: 6b289c5f574851c3d4438e2eeea94f5f5d26dc4f
ms.sourcegitcommit: a1f565fd202c1b9fd8c74f814baa499bbb4ed4a6
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/02/2020
ms.locfileid: "96508003"
---
...
如果没有 Azure 订阅，可以在开始前[注册一个 Azure 帐户](https://www.microsoft.com/china/azure/index.html?fromtype=cn)。 有关构建逻辑应用的详细信息，请参阅[创建逻辑应用](../logic-apps/quickstart-create-first-logic-app-workflow.md)。

## <a name="create-logic-apps-from-templates"></a>从模板创建逻辑应用

1. 如果尚未登录到 [Azure 门户](https://portal.azure.cn "Azure 门户")，现在请登录。
...
1. 在 [Azure 门户](https://portal.azure.cn "Azure 门户")的逻辑应用设计器中，找到并打开你的逻辑应用。
