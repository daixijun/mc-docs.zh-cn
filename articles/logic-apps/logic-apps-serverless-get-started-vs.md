...
* 以下工具。 如果还没有这些工具，请下载并安装它们。
    ...
    * [用于 .NET 的 Microsoft SDK（2.9.1 或更高版本）](https://docs.azure.cn/downloads/)。 
  
        详细了解[用于 .NET 的 Azure SDK](https://docs.azure.cn/dotnet/dotnet-tools)。
...
1. 在“文件”菜单中，选择“新建” > “项目”。
    ...
    :::image type="content" source="./media/logic-apps-serverless-get-started-vs/create-new-project-visual-studio.png" alt-text="在 Visual Studio 中创建新项目":::

1. 在“已安装”下，选择“Visual C#”或“Visual Basic”    。 
    然后，选择“云”   >   “Azure 资源组”。
...
1. 在搜索框中，输入“logic-app”作为筛选器。 
    从结果中选择 **101-logic-app-and-function-app** 模板。

    :::image type="content" source="./media/logic-apps-serverless-get-started-vs/select-template.png" alt-text="选择 Azure 快速入门模板":::
    ...
    :::image type="content" source="./media/logic-apps-serverless-get-started-vs/create-serverless-solution.png" alt-text="新无服务器解决方案":::
...
1. 在解决方案资源管理器中，从资源项目的快捷菜单中选择“部署”>“新建” 。
    ...
    :::image type="content" source="./media/logic-apps-serverless-get-started-vs/deploy.png" alt-text="创建资源组的新部署":::

1. 如果尚未选择它们，请选择你的 Azure 订阅以及要向其部署内容的资源组。 然后，选择“部署”。 

    :::image type="content" source="./media/logic-apps-serverless-get-started-vs/deploy-to-resource-group.png" alt-text="部署设置":::

1. 如果“编辑参数”框已出现，请提供部署时要用于逻辑应用和 Azure 函数应用的资源名称，然后保存设置。  请务必对函数应用使用全局唯一的名称。

    :::image type="content" source="./media/logic-apps-serverless-get-started-vs/logic-function-app-name-parameters.png" alt-text="提供逻辑应用和函数应用的名称":::
...
1. 从解决方案资源管理器的 azuredeploy.json 文件的快捷菜单中选择“使用逻辑应用设计器打开”。
    ...
    :::image type="content" source="./media/logic-apps-serverless-get-started-vs/open-logic-app-designer.png" alt-text="在逻辑应用设计器中打开 azuredeploy.json":::
...
1. 显示“逻辑应用属性”框后，在“订阅”下面选择自己的 Azure 订阅（如果尚未选择）。   在“资源组”下面，选择解决方案部署到的资源组和位置，然后选择“确定”。  
    ...
    :::image type="content" source="./media/logic-apps-serverless-get-started-vs/logic-app-properties.png" alt-text="逻辑应用属性":::

    逻辑应用设计器打开后，可以继续添加步骤或更改工作流，并保存更新。

    :::image type="content" source="./media/logic-apps-serverless-get-started-vs/opened-logic-app.png" alt-text="在逻辑应用设计器中打开的逻辑应用":::
