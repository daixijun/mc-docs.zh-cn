...
使用 [az network nic create](/cli/network/nic?view=azure-cli-latest#az-network-nic-create) 创建两个网络接口：
...
使用 [az network nic create](/cli/network/nic?view=azure-cli-latest#az-network-nic-create) 创建网络接口：
