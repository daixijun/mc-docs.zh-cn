...
ms.date: 12/28/2020
ms.author: v-johya
ms.openlocfilehash: 65050737d45f7fe6579a51913648bcb09300062e
ms.sourcegitcommit: b4fd26098461cb779b973c7592f951aad77351f2
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/04/2021
ms.locfileid: "97857161"
---
...
- 任一方法：从 [LUIS 门户](https://luis.azure.cn/)[将应用版本导出](./luis-how-to-manage-versions.md#other-actions)为 `.lu`，然后将其添加到源代码管理存储库
...
- 用于性能测试的[批处理测试文件](./luis-concept-batch-test.md#batch-file-format)（言语和预期结果）
