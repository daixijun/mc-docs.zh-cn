...
ms.date: 11/20/2020
ms.author: v-tawe
ms.openlocfilehash: 095503a90dc2bd048bd44ccefaae0bfcfb8e9ce2
ms.sourcegitcommit: c2c9dc65b886542d220ae17afcb1d1ab0a941932
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/20/2020
ms.locfileid: "95970784"
---
...
```curl
curl --location --request POST 'https://INSERT_REGION_HERE.tts.speech.azure.cn/cognitiveservices/v1' \
...
```curl
curl --location --request GET 'https://INSERT_ENDPOINT_HERE.tts.speech.azure.cn/cognitiveservices/voices/list' \
--header 'Ocp-Apim-Subscription-Key: INSERT_SUBSCRIPTION_KEY_HERE'
```
