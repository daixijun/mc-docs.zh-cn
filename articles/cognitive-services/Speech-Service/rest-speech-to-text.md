...
语音转文本 REST API 包括：
- [语音转文本 REST API v3.0](#speech-to-text-rest-api-v30)，用于[批量听录](batch-transcription.md)和[自定义语音识别](custom-speech-overview.md)。 v3.0 是 [v2.0 的后继版本](/cognitive-services/speech-service/migrate-v2-to-v3)。
...
如果使用的是语音转文本 REST API v2.0，请参阅[本指南](/cognitive-services/speech-service/migrate-v2-to-v3)中迁移到 v3.0 的方式。

请参阅[此处](https://chinaeast2.dev.cognitive.azure.cn/docs/services/speech-to-text-api-v3-0)完整的语音转文本 REST API v3.0 参考。
