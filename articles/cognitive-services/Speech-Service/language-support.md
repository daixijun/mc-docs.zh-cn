...
ms.openlocfilehash: 89449493f7d5e5714225c3bfad062221044af503
ms.sourcegitcommit: e8f79dbea2f4f2529b09fb7705da0b9bd16631f3
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/12/2021
ms.locfileid: "98114128"
---
...
语音自定义适用于 `de-DE`、`en-GB`、`en-IN`、`en-US`、`es-MX`、`fr-FR` 和 `zh-CN`。 选择与训练自定义语音模型所需的训练数据相匹配的正确区域设置。 例如，如果你的录音数据是以带英国口音的英语说出的，请选择 `en-GB`。
