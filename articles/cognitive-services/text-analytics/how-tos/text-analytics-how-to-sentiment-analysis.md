...
ms.date: 12/30/2020
ms.author: v-johya
ms.openlocfilehash: fb3ff502e972b25ca88126bd250d154044eca5d1
ms.sourcegitcommit: b4fd26098461cb779b973c7592f951aad77351f2
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/04/2021
ms.locfileid: "97856881"
---
...
若要在结果中获取观点挖掘，必须在情绪分析请求中包含 `opinionMining=true` 标志。 观点挖掘结果将包含在情绪分析响应中。 观点挖掘是情绪分析的扩展，包含在你当前的[定价层](https://www.azure.cn/pricing/details/cognitive-services)中。
...
[情绪分析 v3.1 参考](https://dev.cognitive.azure.cn/docs/services/TextAnalytics-v3-1-preview-3/operations/Sentiment)
