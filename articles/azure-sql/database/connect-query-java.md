...
本主题演示如何创建示例应用程序，使其使用 Java 和 [JDBC](https://en.wikipedia.org/wiki/Java_Database_Connectivity) 在 [Azure SQL Database](/sql-database/) 中存储和检索信息。
...
- `<YOUR_AZURE_REGION>`：将使用的 Azure 区域。 可输入 `az account list-locations`，获取可用区域的完整列表。
