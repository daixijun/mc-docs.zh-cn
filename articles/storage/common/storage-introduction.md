...
ms.openlocfilehash: b097d5025794d6215a1fda20a6a43556efa67bce
ms.sourcegitcommit: 5f07189f06a559d5617771e586d129c10276539e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/12/2020
ms.locfileid: "94552852"
---
...
为了确保数据的持久性，Azure 存储会存储多个数据副本。 设置存储帐户时，可选择冗余选项。 有关详细信息，请参阅 [Azure 存储冗余](./storage-redundancy.md?toc=%252fstorage%252fblobs%252ftoc.json)。
...
- [存储服务管理 REST API (Classic)](https://docs.microsoft.com/previous-versions/azure/reference/ee460790(v=azure.100))
...
- [适用于 .NET 的存储数据移动客户端库](https://docs.azure.cn/zh-cn/dotnet/api/microsoft.windowsazure.storage.datamovement)
