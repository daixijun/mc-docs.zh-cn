...
ms.openlocfilehash: 108ff7601981f375c083c60abc3883b95bd7dbb1
ms.sourcegitcommit: f086abe8bd2770ed10a4842fa0c78b68dbcdf771
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/13/2021
ms.locfileid: "98163218"
---
...
本指南演示如何使用 Azure 队列存储服务执行常见方案。 相关示例是使用 Ruby Azure API 编写的。 介绍的方案包括 **插入**、**扫视**、**获取** 和 **删除** 队列消息以及 **创建和删除队列**。
...
若要在 Azure 队列存储（在本文中讨论）和 Azure 服务总线队列（在[如何使用服务总线队列](/service-bus-messaging/service-bus-ruby-how-to-use-queues)中讨论）之间进行比较，请参阅 [Azure 队列存储和服务总线队列 - 比较与对照](../../service-bus-messaging/service-bus-azure-and-service-bus-queues-compared-contrasted.md)
