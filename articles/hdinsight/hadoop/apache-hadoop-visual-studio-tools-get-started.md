...
ms.date: 06/22/2020
ms.author: v-yiso
ms.openlocfilehash: 114dc275be6c707328a1172add782771a1e3d680
ms.sourcegitcommit: 5f07189f06a559d5617771e586d129c10276539e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/12/2020
ms.locfileid: "94552892"
---
...
> [!NOTE]  
> 有关连接到常规 Hadoop 群集的信息，请参阅[如何使用 Visual Studio 编写和提交 Hive 查询](https://docs.microsoft.com/archive/blogs/xiaoyong/how-to-write-and-submit-hive-queries-using-visual-studio)。
