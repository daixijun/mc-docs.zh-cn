...
ms.author: v-yeche
ms.openlocfilehash: ccbf08f1d002609e063fc6773b9d12a6ddcab94e
ms.sourcegitcommit: 7a5c52be6a673649ce3c845d19a9fc9b0c508734
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/19/2020
ms.locfileid: "94915115"
---
...
## <a name="open-resources"></a><a name="open-resources"></a>打开资源
...
2. 在左窗格中选择 Azure 服务。 在本例中，请选择“存储帐户”。   如果该服务未列出，请选择“所有服务”，然后选择服务类型。 
    ...
    :::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-open-service.png" alt-text="在门户中打开 Azure 资源":::

3. 选择要打开的资源。

    :::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-open-resource.png" alt-text="在门户中打开 Azure 资源":::

    存储帐户类似于：

    :::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-open-resource-storage.png" alt-text="在门户中打开 Azure 资源":::
...
:::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-manage-resource.png" alt-text="管理 Azure 资源":::
...
2. 选择“删除”  。 以下屏幕截图显示了虚拟机的管理选项。
    ...
    :::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-delete-resource.png" alt-text="删除 Azure 资源":::
...
2. 选择“移动”  。 以下屏幕截图显示了存储帐户的管理选项。
    ...
    :::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-move-resource.png" alt-text="移动 Azure 资源":::
...
2. 选择“锁定”。  以下屏幕截图显示了存储帐户的管理选项。
    ...
    :::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-lock-resource.png" alt-text="锁定 Azure 资源":::
3. 选择“添加”，然后指定锁定属性。 
...
2. 选择“标记”。  以下屏幕截图显示了存储帐户的管理选项。
    ...
    :::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-tag-resource.png" alt-text="标记 Azure 资源":::
3. 指定标记属性，然后选择“保存”。 
...
:::image type="content" source="./media/manage-resources-portal/manage-azure-resources-portal-monitor-resource.png" alt-text="监视 Azure 资源":::
