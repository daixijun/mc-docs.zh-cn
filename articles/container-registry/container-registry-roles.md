...
ms.date: 11/30/2020
ms.author: v-yeche
ms.openlocfilehash: a823cf4484a19aa7fcc521f9f2b1b0b306f3ad5c
ms.sourcegitcommit: ea52237124974eda84f8cef4bf067ae978d7a87d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/25/2020
ms.locfileid: "96024634"
---
<!--Verify successfully-->
...
Azure 资源管理器访问权限是 Azure 门户和使用 [Azure CLI](https://docs.azure.cn/cli/) 进行注册表管理所需的。 例如，若要通过 `az acr list` 命令获取一系列注册表，需要此权限集。 
