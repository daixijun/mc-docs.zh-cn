...
ASP.NET Core 提供了[适用于应用服务的内置日志记录提供程序](https://docs.microsoft.com/aspnet/core/fundamentals/logging/#azure-app-service)。 在项目的 *Program.cs* 中，通过 `ConfigureLogging` 扩展方法将该提供程序添加到应用程序，如以下示例所示：
