...
ms.openlocfilehash: 38d5e1a2bee6f726101e3ec213903160262f89b5
ms.sourcegitcommit: 79a5fbf0995801e4d1dea7f293da2f413787a7b9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/08/2021
ms.locfileid: "98022965"
---
...
1. 你的选项取决于你是否已登录 Azure 以及是否有一个链接到 Azure 帐户的 Visual Studio 帐户。 选择“添加帐户”或“登录”以登录 Azure 订阅。 如果你已经登录，请选择所需的帐户。
   ...
   :::image type="content" source="./media/quickstart-dotnetcore/sign-in-azure-vs2019.png" alt-text="登录到 Azure":::

1. 在“应用服务实例”的右侧，单击“+” 。

   :::image type="content" source="./media/quickstart-dotnetcore/publish-new-app-service.png" alt-text="新的应用服务应用":::
...
2. 选择“创建”以创建 Azure 资源。
   ...
   :::image type="content" source="./media/quickstart-dotnetcore/web-app-name-vs2019.png" alt-text="创建应用资源":::
...
- 可以选择包含参数 `--location <location-name>`，其中 `<location-name>` 是可用的 Azure 区域。 可以运行 [`az account list-locations`](https://docs.azure.cn/cli/appservice#az_appservice_list_locations) 命令来检索 Azure 帐户的允许区域列表。
...
:::image type="content" source="./media/quickstart-dotnetcore/az-webapp-up-output-3.1.png" alt-text="az webapp up 命令的示例输出":::
...
:::image type="content" source="./media/quickstart-dotnetcore/az-webapp-up-output-5.0.png" alt-text="az webapp up 命令的示例输出":::
...
:::image type="content" source="media/quickstart-dotnetcore/portal-app-overview-up.png" alt-text="Azure 门户中的应用服务页":::
