...
ms.openlocfilehash: 2d590d59588a634fbfc7dde0e73bb10e94f28da0
ms.sourcegitcommit: 79a5fbf0995801e4d1dea7f293da2f413787a7b9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/08/2021
ms.locfileid: "98022928"
---
...
| [`az webapp log config`](https://docs.azure.cn/cli/webapp/log#az_webapp_log_config) | 配置应用服务应用将持久保留的日志。 |
| [`az webapp log download`](https://docs.azure.cn/cli/webapp/log#az_webapp_log_download) | 将应用服务应用的日志下载到本地计算机。 |
