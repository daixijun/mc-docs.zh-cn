...
ms.author: v-yeche
ms.custom: MVC
ms.openlocfilehash: 08dc1a1be02b93e7871eec3315cba25cada16870
ms.sourcegitcommit: c2c9dc65b886542d220ae17afcb1d1ab0a941932
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/20/2020
ms.locfileid: "94978231"
---
...
本文是系列教程的第三篇文章，介绍如何为 Azure VMware 解决方案 VM 设置到 Azure 的灾难恢复。 在上一篇教程中，我们已[准备 Azure VMware 解决方案环境](avs-tutorial-prepare-avs.md)，以便能够灾难恢复到 Azure。

在本教程中，你将了解如何执行以下操作：

> [!div class="checklist"]
>
> * 在 Azure VMware 解决方案私有云中设置源复制设置，以及一个 Site Recovery 配置服务器
> * 设置复制目标。
> * 创建复制策略。
> * 为 VMware VM 启用复制。
...
3. 在本教程中，我们介绍如何复制单个 VM。 若要部署多个 VM，则应使用[部署规划器工具](https://aka.ms/asr-deployment-planner)。 [详细了解](site-recovery-deployment-planner.md)此工具。
...
> [运行灾难恢复演练](avs-tutorial-dr-drill-azure.md)
