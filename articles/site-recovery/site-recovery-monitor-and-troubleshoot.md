...
ms.author: v-yeche
ms.openlocfilehash: 16c9e89e7520d2354bfe2e00e668ec97192887a0
ms.sourcegitcommit: 6b499ff4361491965d02bd8bf8dde9c87c54a9f5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/06/2020
ms.locfileid: "94328646"
---
...
1. 在保管库中，单击“概览”  。 恢复服务仪表板在单个位置合并了保管库的所有监视信息。 Site Recovery 和 Azure 备份服务都有页面，可在这些页面之间切换。
    ...
    :::image type="content" source="./media/site-recovery-monitor-and-troubleshoot/dashboard.png" alt-text="Site Recovery 仪表板":::

2. 在该仪表板中，向下钻取到不同的区域。 

    :::image type="content" source="./media/site-recovery-monitor-and-troubleshoot/site-recovery-overview-page.png" alt-text="屏幕截图显示了仪表板上可以向下钻取到的区域":::。
...
- 将鼠标指针悬停在错误图标上会显示错误和受影响实体的数目。 单击图标会显示受影响实体的筛选列表。
    ...
    :::image type="content" source="./media/site-recovery-monitor-and-troubleshoot/site-recovery-vault-infra-view.png" alt-text="Site Recovery 基础结构视图（保管库）":::
...
在“复制的项”中，获取复制的计算机的列表。 
    :::image type="content" source="./media/site-recovery-monitor-and-troubleshoot/site-recovery-virtual-machine-list-view.png" alt-text="Site Recovery 中“复制的项”列表视图":::
...
6. 单击某个计算机可以深入查看其更多详细信息。 详细信息包括：
    ...
    - **基础结构视图**：显示将计算机复制到 Azure 时的基础结构状态。
        ...
        :::image type="content" source="./media/site-recovery-monitor-and-troubleshoot/site-recovery-virtual-machine-details.png" alt-text="Azure Site Recovery 中复制的项详细信息/概述":::
...
在保管库中转到“监视”部分，单击“Site Recovery 事件”。 
1. 单击“电子邮件通知”。
1. 在“电子邮件通知”中，启用通知并指定收件人。 可向所有订阅管理员发送通知，并选择性地发送到特定的电子邮件地址。

    :::image type="content" source="./media/site-recovery-monitor-and-troubleshoot/email.png" alt-text="电子邮件通知":::
