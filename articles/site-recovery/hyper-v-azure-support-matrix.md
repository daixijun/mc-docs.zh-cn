...
**组件** | **要求** | **详细信息**
--- | --- | ---
来宾操作系统 | Site Recovery 支持 [Azure 支持的](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc794868(v=ws.10))所有操作系统。  | 如果不支持，先决条件检查会失败。
