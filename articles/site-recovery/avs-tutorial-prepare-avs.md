...
## <a name="prepare-an-account-for-automatic-discovery"></a><a name="prepare-an-account-for-automatic-discovery"></a>为自动发现准备帐户
...
<!--Not Available on [software versions](../azure-vmware/concepts-private-clouds-clusters.md#vmware-software-versions)-->
