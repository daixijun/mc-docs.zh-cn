...
2. 导航到“IP 配置”，然后单击所需 IP 配置的名称字段。 :::image type="content" source="media/site-recovery-failover-to-azure-troubleshoot/IpConfigurations.png" alt-text="屏幕截图显示已选择 IP 配置名称的网络接口的“IP 配置”页面。":::
