...
ms.author: v-yeche
ms.topic: conceptual
ms.openlocfilehash: e346db40118050d401987a331c7cefd0bcf30db2
ms.sourcegitcommit: c2c9dc65b886542d220ae17afcb1d1ab0a941932
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/20/2020
ms.locfileid: "94977741"
---
...
## <a name="general"></a><a name="general"></a>常规

### <a name="how-is-site-recovery-priced"></a>Site Recovery 如何计费？

了解 Azure VM 灾难恢复的[费用](https://www.azure.cn/pricing/details/site-recovery)。

<!--Price is correct on https://www.azure.cn/pricing/details/site-recovery-->

### <a name="how-does-the-free-tier-work"></a>免费层如何工作？

每个使用 Site Recovery 保护的实例在前 31 天均可免费享受保护。 在该时间段后，对每个实例的保护将按照[定价详细信息](https://www.azure.cn/pricing/details/site-recovery/)中汇总的费率进行收费。 你可以使用 [Azure 定价计算器](https://www.azure.cn/pricing/calculator/?service=site-recovery)估算费用。

<!--Price is correct on https://www.azure.cn/pricing/details/site-recovery-->

### <a name="do-i-incur-other-azure-charges-in-the-first-31-days"></a>在前 31 天内是否会产生其他 Azure 费用？

是的。 尽管 Azure Site Recovery 在实例受保护的前 31 天是免费的，但你可能需要支付 Azure 存储、存储交易和数据传输费用。 恢复后的 VM 也可能会产生 Azure 计算费用。

<!--MOONCAKE CORRECT ON REMOVE 'G'-->
...
## <a name="replication"></a><a name="replication"></a>复制
...
当前，在门户中，只能选择与保管库位于同一资源组中的自动化帐户。 你可以使用 PowerShell 从不同的资源组中选择自动化帐户。
...
<!--MOONCAKE: Not Available on### Can I replicate VMs in an availability zone to another region?-->


<!--MOONCAKE: Not Available on### Can I replicate non-zone VMs to a zone within the same region-->
<!--MOONCAKE: Not Available on ### Can I replicate zoned VMs to a different zone in the same region?-->
...
## <a name="replication-policy"></a><a name="replication-policy"></a>复制策略
...
:::image type="content" source="./media/azure-to-azure-common-questions/recovery-points.png" alt-text="生成的恢复点列表":::
...
## <a name="multi-vm-consistency"></a><a name="multi-vm-consistency"></a>多 VM 一致性
...
## <a name="failover"></a><a name="failover"></a>故障转移
...
Site Recovery 的 [RTO SLA 为两小时](https://www.azure.cn/support/sla/site-recovery/)。 大多数情况下，Site Recovery 会在几分钟内对 VM 进行故障转移。 若要计算 RTO，请查看故障转移作业，该作业显示启动 VM 所需的时间。 

## <a name="recovery-plans"></a><a name="recovery-plan"></a>恢复计划
...
:::image type="content" source="./media/azure-to-azure-common-questions/recovery-plan-rto.png" alt-text="列出显示 RTO 的测试故障转移持续时间的作业":::

<!--Not Available on ### Can I add automation runbooks to recovery plans?-->
<!--Not Avaialble on [Learn more](site-recovery-runbook-automation.md)-->
