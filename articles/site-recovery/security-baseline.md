...
<!--Not Available on [Azure Site Recovery Private Link Support](azure-to-azure-how-to-enable-replication-private-endpoints.md)-->
...
<!--Not Available on [How to integrate Azure Activity Logs into Azure Monitor](https://docs.azure.cn/active-directory/howto-integrate-activity-logs-with-log-analytics)-->
...
<!--Not Available on [Replicate virtual machines with Azure Private Endpoints](azure-to-azure-how-to-enable-replication-private-endpoints.md)-->
