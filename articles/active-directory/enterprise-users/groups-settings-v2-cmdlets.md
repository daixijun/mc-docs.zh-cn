...
Microsoft 365 组写回是 Azure Active Directory (Azure AD) 的一项公共预览功能，可通过任何付费 Azure AD 许可计划获得。 有关预览版的一些法律信息，请参阅 [Azure 预览版补充使用条款](https://www.azure.cn/support/legal/)。
