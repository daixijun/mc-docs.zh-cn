...
ms.openlocfilehash: 2a15557683071173f4ed754b0034ce812be6eb2a
ms.sourcegitcommit: 883daddafe881e5f8a9f347df2880064d2375b6d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/25/2020
ms.locfileid: "95918480"
---
...
如果 Azure AD 发现某个对象的属性值与来自 Connect 的某个对象的属性值相同，并且前一个对象已在 Azure AD 中存在，则 Azure AD 中的对象会被 Connect 取代。 以前，云管理的对象已标记为在本地管理。 Azure AD 中的所有属性如果在本地 AD 中具有值，这些属性会被本地值覆盖，

> [!WARNING]
> 由于 Azure AD 中的所有属性将被本地值覆盖，因此请确保本地的数据正确。 例如，如果只是在 Microsoft 365 中管理电子邮件地址，而没有在本地 AD DS 中对其进行更新，则会丢失 Azure AD/Microsoft 365 中存在、但在 AD DS 中不存在的所有值。
