...
description: Azure Monitor 中的 Azure Active Directory 活动日志简介
...
* 在 Azure 门户中访问 Azure AD 登录日志所需的 Azure AD Premium 1 或 Premium 2 [许可证](https://www.azure.cn/pricing/details/active-directory/)。 
...
若要针对应用程序的预期数据量进行更准确的估算，请使用 [Azure 存储定价计算器](https://www.azure.cn/pricing/details/storage/blobs/)。
...
若要针对应用程序的预期数据量进行准确的估算，请使用[事件中心定价计算器](https://www.azure.cn/pricing/details/event-hubs/)。

### <a name="azure-monitor-logs-cost-considerations"></a>Azure Monitor 日志成本注意事项

若要查看与管理 Azure Monitor 日志相关的成本，请参阅[通过在 Azure Monitor 日志中控制数据量和保留期管理成本](/azure-monitor/platform/manage-cost-storage)。
