...
ms.openlocfilehash: 9f09ae19cbe919c07b94d3664dad8066212bbdf1
ms.sourcegitcommit: 59810f8eba5e430d85a595e346d3b7fb6e4a0102
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/11/2020
ms.locfileid: "94501923"
---
...
8. 执行下列操作之一：
   ...
   - 如果来宾用户尚不在目录中，请在“选择成员或邀请外部用户”下键入用户的电子邮件地址。 在消息框中，键入个人消息（可选）。 在消息框下，单击“邀请”。
       ...
       ![此屏幕截图突出显示了可添加用户电子邮件地址和个性化消息的位置，还突出显示了“邀请”按钮。](./media/add-users-administrator/AppInviteUsers.png)
