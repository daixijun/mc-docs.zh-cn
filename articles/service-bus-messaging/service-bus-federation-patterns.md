...
<!--You can create (and update) a secondary namespace by following the [guidance for moving namespaces](move-across-regions.md)-->
...
<!-- Update_Description: new article about service bus federation patterns -->
<!--NEW.date: 01/11/2021-->