...
ms.author: v-yeche
ms.openlocfilehash: ae72b90c5d710bc4e4ddd9bf8ded6d0eb122f8d6
ms.sourcegitcommit: d8dad9c7487e90c2c88ad116fff32d1be2f2a65d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/11/2020
ms.locfileid: "97105243"
---
...
也可以直接通过命名空间来访问指标。 为此，请选择命名空间，然后选择“指标”。 若要显示筛选到实体范围的指标，请选择实体，然后选择“指标”。
...
针对 Azure Monitor 的指标和警报按警报收费。 在设置警报时且在保存警报前，可在门户上找到这些费用。 
...
| 完成的消息数| 队列/主题中完成的消息计数。 <br/><br/> 单位：计数 <br/> 聚合类型：平均值 <br/> 维度：实体名称 |
| 已放弃的消息数| 队列/主题中已放弃的消息计数。 <br/><br/> 单位：计数 <br/> 聚合类型：平均值 <br/> 维度：实体名称 |
...
| 标准名称 | 说明 |
| ------------------- | ----------------- |
|活动连接数|命名空间上及其中实体上的活动连接数。 此指标的值为时间点值。 在该时间点之后立即处于活动状态的连接可能不会反映在这些指标中。<br/><br/> 单位：计数 <br/> 聚合类型：总计 <br/> 维度：实体名称|
...
1. 在“创建规则”页面上，展开“定义警报详细信息”，执行以下操作：
    ...
    3. 选择警报的 **严重性**。 
        ...
        :::image type="content" source="./media/service-bus-metrics-azure-monitor/alert-details.png" alt-text="“创建规则”页的屏幕截图。“定义警报详细信息”已展开，并突出显示了“警报规则名称”、“说明”和“严重性”字段。":::
