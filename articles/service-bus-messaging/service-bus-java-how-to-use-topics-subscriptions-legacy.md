...
1. Azure 订阅。 要完成本教程，需要一个 Azure 帐户。 可以激活你的 [Visual Studio 或 MSDN 订阅者权益](https://www.azure.cn/offers/ms-mc-arz-msdn)或者注册[试用版订阅](https://www.microsoft.com/china/azure/index.html?fromtype=cn)。
...
:::image type="content" source="media/service-bus-java-how-to-use-topics-subscriptions-legacy/eclipse-azure-libraries-java.png" alt-text="将适用于 Java 的 Azure 库添加到 Eclipse 项目":::
