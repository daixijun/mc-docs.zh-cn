...
> [!NOTE]
> Azure 磁盘只能使用“访问模式”类型 ReadWriteOnce 进行装载，这使其只可供 AKS 中的一个节点使用。 如果需要在多个节点之间共享永久性卷，请使用 [Azure 文件存储][azure-files-pvc]。
...
[az-disk-show]: https://docs.azure.cn/cli/disk#az_disk_show
