...
ms.openlocfilehash: 6706d99ee203b2fb8856ed360d7cfd74c9df5368
ms.sourcegitcommit: 40db5a4b9ab8b5877e307ff7a567fd930ca81c72
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/05/2021
ms.locfileid: "97894323"
---
...
* 安装了 Azure IoT 扩展 v0.10.6 或更高版本的 Azure CLI v2.3.1。
...
1. 在 [Azure 门户](https://portal.azure.cn/)中，导航到 IoT 中心。
...
1. 在 Azure CLI 中输入以下命令，以在中心创建一个 IoT Edge 设备。 此设备将为顶层设备，因此请输入适当的唯一设备 ID：
...
1. 在 [Azure 门户](https://portal.azure.cn/)中，导航到 IoT 中心的“IoT Edge”部分。
...
1. 在 Azure CLI 中，为每个设备输入以下命令以检索设备的连接字符串，并将其记录到你选择的位置：
...
1. 在 Azure CLI 中输入以下命令，以创建 deployment.json 文件：
