...
当前的 ScheduledQueryRules API 允许你在[指标度量](alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value)规则中设置“聚合依据”，这将按预期工作。
...
优化的查询是日志警报服务运行的内容。 你可以在 Log Analytics [门户](../log-query/log-query-overview.md)或 [API](https://docs.microsoft.com/rest/api/loganalytics/) 中运行修改后的查询。
...
- [查询语言](https://docs.microsoft.com/azure/kusto/query/)的更改包含命令和函数的已修改格式。 因此，以前提供的查询不再有效。
...
- PowerShell - [Get-AzScheduledQueryRule](https://docs.microsoft.com/powershell/module/az.monitor/get-azscheduledqueryrule)
