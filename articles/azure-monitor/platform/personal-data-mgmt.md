...
ms.openlocfilehash: c7aef65316dcfa6fff219c19c65fa53387b9b292
ms.sourcegitcommit: c8ec440978b4acdf1dd5b7fda30866872069e005
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/15/2021
ms.locfileid: "98229875"
---
...
> [!IMPORTANT]
>  虽然绝大多数清除操作完成起来会比 SLA 快得多，但由于其对所用数据平台造成的严重影响，因此 **完成清除操作所需的正式 SLA 设置为 30 天**。 此 SLA 可满足 GDPR 要求。 这是一个自动化过程，没有办法请求更快地处理操作。 
...
> [!NOTE]
> 执行清除操作后，[清除操作状态](https://docs.microsoft.com/rest/api/loganalytics/workspacepurge/getpurgestatus)为“挂起”时，将无法访问数据。 
