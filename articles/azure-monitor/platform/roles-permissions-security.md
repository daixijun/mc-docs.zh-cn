...
ms.author: v-johya
ms.subservice: ''
ms.openlocfilehash: f6bf6fc37e82355667ea5eb078e325061751e99d
ms.sourcegitcommit: d8dad9c7487e90c2c88ad116fff32d1be2f2a65d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/11/2020
ms.locfileid: "97104383"
---
...
* 使用 [Azure Monitor REST API](https://docs.microsoft.com/rest/api/monitor/metrics)、[PowerShell cmdlet](../samples/powershell-samples.md) 或 [跨平台 CLI](../samples/cli-samples.md) 查询指标。
