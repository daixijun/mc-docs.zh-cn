...
ms.openlocfilehash: 29973e02d69639f5a4c86eee8f41454ffdf03563
ms.sourcegitcommit: 6b499ff4361491965d02bd8bf8dde9c87c54a9f5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/06/2020
ms.locfileid: "94328773"
---
...
* 使用[安装向导](#install-agent-using-setup-wizard)或[命令行](#install-agent-using-command-line)手动进行安装。
...
### <a name="sha-2-code-signing-support-requirement"></a>SHA-2 代码签名支持要求 
...
[TLS 1.2](https://azure.microsoft.com/windows-server/security/tls/tls-registry-settings#tls-12) 协议可确保在 Windows 代理与 Log Analytics 服务之间进行通信的传输中数据的安全性。 如果要在[默认情况下未启用 TLS 1.2 的操作系统](data-security.md#sending-data-securely-using-tls-12)上安装，则应使用以下步骤配置 TLS 1.2。
...
以下步骤在计算机上使用代理的安装向导在 Azure 和 Azure 中国云中安装并配置 Log Analytics 代理。
...
## <a name="install-agent-using-command-line"></a>使用命令行来安装代理
...
## <a name="install-agent-using-dsc-in-azure-automation"></a>使用 Azure 自动化中的 DSC 来安装代理
