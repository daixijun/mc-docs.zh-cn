...
* 在[指标资源管理器](../platform/metrics-charts.md)中，自定义图表并将其保存到收藏夹。 将图表固定到 Azure 仪表板。
...
对于 ASP.NET Core 应用程序，你可以使用 [ASP.NET Core 依赖关系注入](https://docs.microsoft.com/aspnet/core/fundamentals/dependency-injection/)访问 `TelemetryConfiguration` 实例。 可在 [ASP.NET Core 应用程序的 ApplicationInsights](./asp-net-core.md) 一文中找到更多详细信息。
