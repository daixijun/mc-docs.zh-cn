...
Microsoft.ApplicationInsights 包提供 SDK 的[核心 API](https://docs.microsoft.com/dotnet/api/microsoft.applicationinsights?view=azure-dotnet)。 其他遥测模块使用此包，也可以[使用它来定义自己的遥测](./api-custom-events-metrics.md)。
