...
Application Insights 是 Azure 中托管的众多服务之一，遥测会发送到此处进行分析和展示。 因此在执行任何其他操作之前，需要订阅 [Azure](https://azure.com)。 可免费注册该订阅，如果选择 Application Insights 的基本[pricing plan](https://www.azure.cn/pricing/details/monitor/)（定价计划），不会产生费用，但如果应用的使用量大幅增加，会产生费用。 如果组织已有订阅，则组织可向其中添加 Microsoft 帐户。
