...
ms.date: 01/04/2020
ms.author: v-jay
ms.openlocfilehash: 1a133aa58a61804bafaa4ea5c75b81078765ed6f
ms.sourcegitcommit: b4fd26098461cb779b973c7592f951aad77351f2
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/04/2021
ms.locfileid: "97857096"
---
...
请查看你的订阅。 Data Box Disk 仅适用于企业协议 (EA) 和云解决方案提供商 (CSP) 订阅产品/服务。 如果没有这两种订阅类型中的任一种，请联系 Azure 支持部门以升级订阅。
...
A.  不是。 Data Box 磁盘目前仅支持一个存储帐户（常规或经典帐户）。 支持热 Blob 和冷 Blob。 
...
A. 是的。 你的数据已上传到 Azure，但如果你看不到任何具有指定资源组的托管磁盘，则可能是因为该数据无效。 如果页 blob、块 blob、Azure 文件存储或托管磁盘无效，系统会将它们置于以下文件夹中：
