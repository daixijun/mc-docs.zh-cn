...
ms.author: v-junlch
ms.topic: conceptual
ms.openlocfilehash: 4d49acd5293b6ecf2354606bd99066690730b8b6
ms.sourcegitcommit: 5f07189f06a559d5617771e586d129c10276539e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/12/2020
ms.locfileid: "94553008"
---
...
首先，请确保已阅读 [WAF 概述](ag-overview.md)和 [WAF 配置](application-gateway-waf-configuration.md)文档。 此外，确保已启用 [WAF 监视](application-gateway-diagnostics.md)。这些文章介绍了 WAF 函数、WAF 规则集的工作原理，以及 WAF 日志的访问方式。
...
还可以检查防火墙日志来获取信息，以确定需要将哪些内容添加到排除列表。 若要启用日志记录，请参阅[应用程序网关的后端运行状况、资源日志和指标](application-gateway-diagnostics.md)。
