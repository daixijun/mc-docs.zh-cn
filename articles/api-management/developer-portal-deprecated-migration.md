...
ms.date: 11/18/2020
ms.author: v-johya
ms.openlocfilehash: 2db43045251cf198926fb214b84cd3389ce29a86
ms.sourcegitcommit: c2c9dc65b886542d220ae17afcb1d1ab0a941932
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/20/2020
ms.locfileid: "94978340"
---
...
- 如果使用委派，请更改应用程序中的返回 URL，并使用[“获取共享访问令牌”API 终结点](https://docs.microsoft.com/rest/api/apimanagement/2019-12-01/user/getsharedaccesstoken)而不是“生成 SSO URL”终结点 。
