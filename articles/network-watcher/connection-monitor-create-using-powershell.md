...
ms.author: v-yeche
ms.openlocfilehash: adbd65eaec0dd119147a9cb5d6d793e33dbda491
ms.sourcegitcommit: b6fead1466f486289333952e6fa0c6f9c82a804a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/27/2020
ms.locfileid: "96300996"
---
<!--Verified successfully-->
# <a name="create-a-connection-monitor-using-powershell"></a>使用 PowerShell 创建连接监视器

了解如何使用 PowerShell 创建连接监视器以监视资源之间的通信。
...
## <a name="steps-to-create-with-powershell"></a>使用 PowerShell 进行创建的步骤
...
* 测试组
    ...
    * sources - 从上面创建的终结点中进行选择。 基于 Azure 的源终结点需要安装 Azure 网络观察程序扩展，基于非 Azure 的源终结点需要安装 Azure Log Analytics 代理。 若要为源安装代理，请参阅[安装监视代理](https://docs.azure.cn/network-watcher/connection-monitor-preview#install-monitoring-agents)。
...
<!-- Update_Description: new article about connection monitor create using powershell -->
<!--NEW.date: 11/30/2020-->