...
ms.testdate: ''
ms.author: v-yeche
ms.openlocfilehash: f794358df4b58476ed954567a79a2e6128bab1b2
ms.sourcegitcommit: c8ec440978b4acdf1dd5b7fda30866872069e005
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/15/2021
ms.locfileid: "98230874"
---
...
- 网络安全组 (NSG) 包含安全规则列表，这些规则可允许或拒绝 VNet 和子网所连接到的资源中的网络流量。 可以将 NSG 与子网、单个 VM 或附加到 VM 的单个网络接口 (NIC)（资源管理器模型）进行关联。 有关详细信息，请参阅[网络安全组概述](../virtual-network/network-security-groups-overview.md?toc=%2fnetwork-watcher%2ftoc.json)。
...
应用程序网关 V2 子网 NSG 的问题：当前[不支持](https://docs.azure.cn/application-gateway/application-gateway-faq#are-nsg-flow-logs-supported-on-nsgs-associated-to-application-gateway-v2-subnet)对应用程序网关 V2 子网 NSG 使用流日志记录。 此问题不会影响应用程序网关 V1。
...
如果收到 AuthorizationFailed 或 GatewayAuthenticationFailed 错误，则表明你可能尚未在订阅上启用 Azure Insights 资源提供程序 。 [按照说明](./network-watcher-nsg-flow-logging-portal.md#register-insights-provider)启用 Azure Insights 提供程序。
