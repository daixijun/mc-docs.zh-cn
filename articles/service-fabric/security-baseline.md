...
<!--Not Available on * [Deploy Azure Firewall using a template](../firewall/deploy-template.md)-->
...
<!--Not Available on * [Configure Azure Monitor logs integration with Service Fabric](./service-fabric-diagnostics-oms-setup.md)-->

<!--Not Available on * [Set up Azure Monitor logs for monitoring containers in Azure Service Fabric](./service-fabric-tutorial-monitoring-wincontainers.md)-->

<!--Not Available on * [Diagnosing common Service Fabric scenarios](./service-fabric-diagnostics-common-scenarios.md)-->
