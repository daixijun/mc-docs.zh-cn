...
* **数据收集、处理和 IoT**：Service Fabric 通过其有状态服务实现大规模处理和低延迟。 它可以帮助你处理数百万台设备上的数据（其中的设备数据和计算数据共置在一起）。
    ...
    <!--Not Available on [using Service Fabric in gaming services](https://docs.azure.cn/gaming/multiplayer-synchronous-sf)-->
    <!--Not Available on [Azure gaming solutions](https://www.azure.cn/solutions/gaming/)-->
    <!--Not Available on [Next Games](https://customers.microsoft.com/story/next-games-media-telecommunications-azure)-->
