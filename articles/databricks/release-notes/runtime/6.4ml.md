...
author: mssaperla
ms.date: 08/10/2020
title: Databricks Runtime 6.4 ML - Azure Databricks
description: 关于由 Apache Spark 提供支持的 Databricks Runtime 6.4 ML 的发行说明。
ms.openlocfilehash: 6f55abae6bf5d299a103d0ba5719512c3956d197
ms.sourcegitcommit: 6b499ff4361491965d02bd8bf8dde9c87c54a9f5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/06/2020
ms.locfileid: "94329069"
---
# <a name="databricks-runtime-64-ml"></a>Databricks Runtime 6.4 ML

Databricks 于 2020 年 2 月发布了此映像。 对此映像的支持截止到 2021 年 4 月。

Databricks Runtime 6.4 ML 基于 [Databricks Runtime 6.4](6.4.md)，为机器学习和数据科学提供了随时可用的环境。
...
Databricks Runtime 6.4 ML 中的系统环境与 Databricks Runtime 6.4 不同，如下所示：
