...
author: mssaperla
ms.date: 08/10/2020
title: Databricks Runtime 6.5 ML - Azure Databricks
description: 关于由 Apache Spark 提供支持的 Databricks Runtime 6.5 ML 的发行说明。
ms.openlocfilehash: f65430c0aabd5fbe3dee6a371b970e3a51d6de38
ms.sourcegitcommit: 6b499ff4361491965d02bd8bf8dde9c87c54a9f5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/06/2020
ms.locfileid: "94329205"
---
# <a name="databricks-runtime-65-ml"></a>Databricks Runtime 6.5 ML

Databricks 于 2020 年 4 月发布了此映像。

Databricks Runtime 6.5 ML 基于 [Databricks Runtime 6.5](6.5.md) 为机器学习和数据科学提供了随时可用的环境。
...
Databricks Runtime 6.5 ML 基于 Databricks Runtime 6.5 构建。 若要了解 Databricks Runtime 6.5 中的新增功能，请参阅 [Databricks Runtime 6.5](6.5.md) 发行说明。

## <a name="improvements"></a>改进

### <a name="upgraded-machine-learning-libraries"></a>升级了机器学习库

* mlflow (Python)：1.5.0 到 1.7.0。 查看 [MLflow 发行说明](https://github.com/mlflow/mlflow/releases/tag/v1.7.0)。

## <a name="deprecations"></a>弃用功能

* 在即将发布的 Databricks Runtime ML 的主版本中，以下 Python 包会被删除：
  * argparse
  * colorama
  * 已弃用
  * et_xmlfile
...
Databricks Runtime 6.5 ML 中的系统环境在以下方面不同于 Databricks Runtime 6.5：
...
## <a name="libraries"></a><a id="libraries"> </a><a id="mlr65-libraries"> </a>库

以下部分列出了 Databricks Runtime 6.5 ML 中包含的库，这些库不同于 Databricks Runtime 6.5 中包含的库。
...
Databricks Runtime 6.5 ML 包含以下顶层[库](../../runtime/mlruntime.md#mllibraries)：
...
Databricks Runtime 6.5 ML 使用 Conda 进行 Python 包管理，并且包含许多常用的 ML 包。 下一部分介绍用于 Databricks Runtime 6.5 ML 的 Conda 环境。
...
R 库与 [Databricks Runtime 6.5 中的 R 库](6.5.md#installed-r-libraries)完全相同。

### <a name="java-and-scala-libraries-scala-211-cluster"></a>Java 和 Scala 库（Scala 2.11 群集）

除了 Databricks Runtime 6.5 中的 Java 库和 Scala 库之外，Databricks Runtime 6.5 ML 还包含以下 JAR：
