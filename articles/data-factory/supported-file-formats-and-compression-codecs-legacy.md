...
ms.date: 11/23/2020
ms.author: v-jay
ms.openlocfilehash: 79f22be2d39892f7a38f8442fb112d470981ce26
ms.sourcegitcommit: c89f1adcf403f5845e785064350136698eed15b8
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/17/2020
ms.locfileid: "94680510"
---
...
| encodingName |指定编码名称。 |有效的编码名称。 请参阅 [Encoding.EncodingName 属性](https://docs.microsoft.com/dotnet/api/system.text.encoding)。 例如：windows-1250 或 shift_jis。 **默认** 值为 **UTF-8**。 |否 |
...
| encodingName |指定编码名称。 有关有效编码名称的列表，请参阅：[Encoding.EncodingName](https://docs.microsoft.com/dotnet/api/system.text.encoding) 属性。 例如：windows-1250 或 shift_jis。 默认值为  ：**UTF-8**。 |否 |
...
* **Level：** 压缩比，可以是 **Optimal** 或 **Fastest**。
  ...
  * **最佳**：以最佳方式完成压缩操作，不过，需要耗费更长的时间。
    ...
    有关详细信息，请参阅 [Compression Level](https://docs.microsoft.com/dotnet/api/system.io.compression.compressionlevel)（压缩级别）主题。
...
可以看到一个示例，它使用 Azure 函数[提取 tar 文件的内容](https://github.com/Azure/Azure-DataFactory/tree/master/SamplesV2/UntarAzureFilesWithAzureFunction)。 有关详细信息，请参阅 [Azure Functions 活动](./control-flow-azure-function-activity.md)。

还可以使用自定义 dotnet 活动构建此功能。 更多的信息可以在[这里](./transform-data-using-dotnet-custom-activity.md)找到
