...
ms.openlocfilehash: 2171578d34bc242f2cd0f25821e68b75c0c9f179
ms.sourcegitcommit: 39288459139a40195d1b4161dfb0bb96f5b71e8e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/13/2020
ms.locfileid: "94590902"
---
...
5. 添加 Azure 通知中心 SDK 模块。
   ...
   - 通过将二进制文件复制到项目中进行集成：可以通过将二进制文件复制到项目中来进行集成，如下所示：
        ...
        - 下载以 zip 文件形式提供的 [Azure 通知中心 SDK](https://github.com/Azure/azure-notificationhubs-android/releases) 框架，然后将其解压缩。
...
9. 打开 **Constants.m** 文件并将其内容替换为以下代码。 将字符串字面量占位符 `NotificationHubConnectionString` 和 `NotificationHubConnectionString` 分别替换为之前从门户中获取的中心名称和 DefaultListenSharedAccessSignature：
...
10. 打开项目 AppDelegate.h 文件，并将其内容替换为以下代码：
...
## <a name="send-test-push-notifications"></a>发送测试推送通知
 ...
 可以在 [Azure 门户](https://portal.azure.cn/)中使用“测试性发送”选项，在应用中测试通知的发送。 它会向设备发送测试性的推送通知。
...
- Azure 移动应用：有关如何从通知中心集成的移动应用后端发送通知的示例，请参阅[将推送通知添加到 iOS 应用](/app-service-mobile/app-service-mobile-ios-get-started-push)。
