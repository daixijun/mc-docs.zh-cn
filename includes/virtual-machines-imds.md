...
ms.openlocfilehash: 3878ef1f7109c1f3031d1867c4ad485a835f1e43
ms.sourcegitcommit: 292892336fc77da4d98d0a78d4627855576922c5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/19/2021
ms.locfileid: "98570555"
---
...
IMDS 适用于运行虚拟机 (VM) 的实例和虚拟机规模集实例。 所有终结点均支持使用 [Azure 资源管理器](https://docs.microsoft.com/rest/api/resources/)创建和管理的 VM。 只有“实例”类别的“经过证明的”类别和“网络”部分支持通过经典部署模型创建的 VM。 “经过证明的”终结点仅在有限的程度上提供这样的支持。
...
> [!IMPORTANT]
> 即使你不知道环境中的任何代理配置的信息，也必须重写任何默认的客户端代理设置。 代理配置可以自动发现，并且未能绕过这样的配置会使你冒服务中断的风险（如果将来要更改计算机的配置）。
...
| `licenseType` | [Azure 混合权益](https://www.azure.cn/pricing/hybrid-benefit)许可证的类型。 这仅适用于启用了 AHB 的 VM | 2020-09-01
...
你可以访问以下网址，在“虚拟机”>“实例元数据服务”下向我们的用户反馈渠道提供产品反馈和想法： https://support.azure.cn/support/contact/
...
<!-- Update_Description: new article about virtual machines imds -->
<!--NEW.date: 01/18/2021-->